  ...
  <div class="panel panel-primary">
    ...
    <div class="panel-body">
      ...
      <form class="form-horizontal" id="formulario_usuario" action="javascript:registrar_personal();">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-2">
                    <select name="combo_especialidad" id="combo_especialidad" class="form-control cumple">
                  ...
                  <button type="button" onclick="validar_indicador_especialidad();" class="btn btn-success ">Buscar&ensp;<i  class="glyphicon glyphicon-floppy-search" aria-hidden="true"></i></button>  
                </div>
            </form>


      <div class="col-sm-8"   width="200" heghti="300"  id="contenedor_marca">
        <p><b>Consultas Registradas por Especialidad </b></p>
   ...
   <script type="text/javascript" src="../framework/Scrips/consola_usuario.js"></script>
    <script>
        ...
        Listar_consultas_especialidad();
        combo_especialidad();
        combo_ano_especialidad();
    	})
    </script>
     ...
     <script type="text/javascript">
      ...
      $("#combo_especialidad").on("change", function(){  
       combo_ano_especialidad();
